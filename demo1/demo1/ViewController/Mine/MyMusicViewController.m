...
- (void)viewDidLoad {
    ...
    UIButton *btn1 = [GlobalObject newButton:CGRectMake(100, 100, 60, 40) title:@"第一首" titleColor:nil normalBkg:nil highlightedBkg:nil];
    ...
    UIButton *btn3 = [GlobalObject newButton:CGRectMake(100, 200, 60, 40) title:@"上一首" titleColor:nil normalBkg:nil highlightedBkg:nil];
    btn3.backgroundColor = [UIColor redColor];
    [btn3 addTarget:self action:@selector(playTheLast:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:btn3];
    
    UIButton *btn4 = [GlobalObject newButton:CGRectMake(200, 200, 60, 40) title:@"下一首" titleColor:nil normalBkg:nil highlightedBkg:nil];
